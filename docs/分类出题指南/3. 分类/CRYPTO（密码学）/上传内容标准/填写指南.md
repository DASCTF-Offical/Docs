...
对于 Crypto 题来说，如果有需要，环境文件，也就是 Dockerfile。
...
1.  无环境的题目可以选择 静态Flag，填写flag即可。
    1.  flag只需要填写 DASCTF{} 括号里的内容即可，比如 flag 是 DASCTF{xxxxx}，那么只需要填写 xxxxx 即可。
        
        ![](19_填写指南_image.png)
        
2.  有环境的题目均强制要求 **动态Flag**。
    1.  再次强调，请在题目容器文件中接收 “**DASFLAG**” 环境作为 flag！
