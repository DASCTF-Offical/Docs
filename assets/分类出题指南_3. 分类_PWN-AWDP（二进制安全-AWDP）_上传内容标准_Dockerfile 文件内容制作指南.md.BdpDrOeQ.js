import{_ as a,c as n,ab as p,o as e}from"./chunks/framework.B0GWKKDs.js";const l="/assets/Dockerfile%20%E6%96%87%E4%BB%B6%E5%86%85%E5%AE%B9%E5%88%B6%E4%BD%9C%E6%8C%87%E5%8D%97_image.Ab9DjAnL.png",g=JSON.parse('{"title":"Dockerfile 文件内容制作指南","description":"","frontmatter":{},"headers":[],"relativePath":"分类出题指南/3. 分类/PWN-AWDP（二进制安全-AWDP）/上传内容标准/Dockerfile 文件内容制作指南.md","filePath":"分类出题指南/3. 分类/PWN-AWDP（二进制安全-AWDP）/上传内容标准/Dockerfile 文件内容制作指南.md","lastUpdated":1734019302000}'),c={name:"分类出题指南/3. 分类/PWN-AWDP（二进制安全-AWDP）/上传内容标准/Dockerfile 文件内容制作指南.md"};function i(t,s,o,r,d,m){return e(),n("div",null,s[0]||(s[0]=[p('<h1 id="dockerfile-文件内容制作指南" tabindex="-1">Dockerfile 文件内容制作指南 <a class="header-anchor" href="#dockerfile-文件内容制作指南" aria-label="Permalink to &quot;Dockerfile 文件内容制作指南&quot;">​</a></h1><h2 id="文件下载" tabindex="-1">文件下载 <a class="header-anchor" href="#文件下载" aria-label="Permalink to &quot;文件下载&quot;">​</a></h2><p><a href="../%E6%96%87%E4%BB%B6%E4%B8%8B%E8%BD%BD/docker-awdp.zip">docker-awdp.zip</a></p><h2 id="和-pwn-题的不同" tabindex="-1">和 PWN 题的不同 <a class="header-anchor" href="#和-pwn-题的不同" aria-label="Permalink to &quot;和 PWN 题的不同&quot;">​</a></h2><p>把 SSH 打开，账号 <strong>ctf（运维账户，给到程序文件的修改权限）</strong>，密码 1qazcde3!@#。原因：<strong>flag文件需要保留，接收 DASFLAG 作为flag，因为这个靶机既要作为攻击靶机（SSH信息不展示），也要作为防守靶机（SSH信息要展示）。</strong></p><h2 id="文件包结构" tabindex="-1">文件包结构 <a class="header-anchor" href="#文件包结构" aria-label="Permalink to &quot;文件包结构&quot;">​</a></h2><p>文件包内应确保具有如下的文件。</p><p><img src="'+l+`" alt=""></p><ol><li>docker-compose.yml – Docker-Compose 描述文件</li><li>pwn1 – 服务构建文件，下有 Dockerfile 和构建所需的文件等</li></ol><h2 id="docker-compose-yml" tabindex="-1">docker-compose.yml <a class="header-anchor" href="#docker-compose-yml" aria-label="Permalink to &quot;docker-compose.yml&quot;">​</a></h2><p>Docker-Compose 描述文件, 内容如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>version: &quot;3&quot;</span></span>
...
<span class="line"><span>    apt-get install -y lib32z1 xinetd openssh-server</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>done</span></span></code></pre></div><p>禁止使用这种输出日志的方式来保持运行。</p><p>禁止使用这种输出日志的方式来保持运行。</p><p>禁止使用这种输出日志的方式来保持运行。</p>`,37)]))}const f=a(c,[["render",i]]);export{g as __pageData,f as default};
